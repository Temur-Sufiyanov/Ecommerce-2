...
from .views import home, category_view, productDetail, about, contact, all_products,search, customRegister, terms, customLogin, customLogout
from django.contrib.auth import views as auth_views
from .views import CustomPasswordResetView, CustomPasswordResetConfirmView, profile_view, MyPasswordChangeDoneView, MyPasswordChangeView, add_to_cart, cart_view, cart_update, cart_item_remove, create_order, order_list, order_detail, wishlist, add_to_wishlist, remove_from_wishlist
...
urlpatterns = [
    ...
    path('cart/remove/<int:item_id>/', cart_item_remove, name='item_remove'),
    path('cart/', cart_view, name='cart'),
    path('cart/create-order/', create_order, name='checkout'),
    path('cart/orders/', order_list, name='order_list'),
    path('cart/order-detail/<int:order_id>/', order_detail, name='order_detail'),
