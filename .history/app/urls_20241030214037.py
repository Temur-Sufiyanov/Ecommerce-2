...
from .views import home, category_view, productDetail, about, contact, all_products,search_bar, customRegister, terms, customLogin
...
urlpatterns = [
    ...
    path('login/', customRegister, name='register'),
