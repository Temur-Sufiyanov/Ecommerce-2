...
from django.contrib.auth.views import PasswordResetView, Set
...
class CustomPasswordResetForm(PasswordResetView):
    email = forms.EmailField(
        label='Email Address',
        widget=forms.EmailInput(attrs={
            'class':'form-control',
...
class CustomPasswordResetConfirmForm(PasswordResetConfirmView):
