...
from .views import CustomPasswordResetView, CustomPasswordResetConfirmForm
...
urlpatterns = [
    ...
    path('reset/<uidb64>/<token>/', CustomPasswordResetConfirmForm.as_view(), name='password_reset_confirm'),
