...
from .forms import RatingForm, ClientMessageForm, CustomRegistrationForm, CustomLoginForm, CustomPasswordResetForm
...
class CustomPasswordResetView(PasswordResetView)
    ...
    template_name = 'app/registration/app/registration/password_reset_form.html'