...
from .views import CustomPasswordResetView, CustomPasswordResetConfirmView, profile_view, profile_edit, add_profile_info
...
urlpatterns = [
    ...
    path('profile/add', add_profile_info, name='add_profile'),
]
