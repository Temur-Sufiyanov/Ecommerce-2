...
from .forms import RatingForm, ClientMessageForm, CustomRegistrationForm, CustomLoginForm, CustomPasswordResetForm, CustomPasswordResetConfirmForm, CustomerForm, Pa
