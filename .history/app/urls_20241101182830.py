...
urlpatterns = [
    ...
    path('reset/<iud64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='app/registration/password_reset_confi.html'), name='password_reset_confirm'),
